...
class ArrowMarkerPublisher(Node):
    ...
    def publish_marker(self, xpos, ypos):
        ...
        marker.pose.orientation.y = 0.0 #-(math.pi/2)
...
def get_yellow_object_coordinates(image):
    ...
    if len(contours)>0: 
        ...
        if w>180 and PositionMarked>0:
            ...
            # marker_obj.publish_marker(xpos=0.2, ypos=0.2)
            # Gebe die Koordinaten des Begrenzungsrechtecks aus
